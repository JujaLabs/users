...
public class UserServiceTest {
    ...
    public void getUsersBySlackNames() throws Exception {
        ...
        User user1 = new User(uuid1, "Vasya", "Ivanoff", "vasya@mail.ru", "vasya@gmail.com",
                "vasya", "vasya.ivanoff", 777L);
        User user2 = new User(uuid2, "Kolya", "Sidoroff", "kolya@mail.ru", "kolya@gmail.com",
                "kolya", "kolya.sidoroff", 888L);
