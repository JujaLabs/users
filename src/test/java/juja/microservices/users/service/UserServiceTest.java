...
public class UserServiceTest {
    ...
    public void updateUsersFromCRMTest() throws Exception {
        ...
        allCrmUsers.add(new UserCRM(1L, "Alex", "Batman",
                "Alex", 100L, "alex.batman", 1, "00000000-0000-0001-0000-000000000002", "Assigned", 1));
        allCrmUsers.add(new UserCRM(2L, "Max", "Superman",
                "Max", 200L, "max.superman", 1, "00000000-0000-0001-0000-000000000003", "Assigned", 1));
    ...
    public void updateUsersFromCRMWithNullFieldTest() throws Exception {
        //given
        List<UserCRM> allCrmUsers = new ArrayList<>();
        allCrmUsers.add(new UserCRM(1L, "Alex", "Batman", "Alex", 100L, "Alex", 1, null, "Assigned", 1));
        allCrmUsers.add(new UserCRM(2L, "Max", "Superman", "Max", 200L, "max.superman", 1, "00000000-0000-0001-0000-000000000003", "Assigned", 1));
